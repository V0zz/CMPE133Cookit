...
public class MainMenuPanel extends JFrame {
	...
	public MainMenuPanel() {
		...
		potLabel = new JLabel("");
		potLabel.setIcon(new ImageIcon(MainMenuPanel.class.getResource("./resources/pot.png")));
		...
		plateLabel.setIcon(new ImageIcon(MainMenuPanel.class.getResource("./resources/plate.png")));
		...
		grillLabel.setIcon(new ImageIcon(MainMenuPanel.class.getResource("./resources/grill.png")));
